...
public class MockReimbursement {
	public void Reimbursement_() {
		...
		Reimbursement_ Process1 = new Reimbursement_(1, 1, 1, "Oracle Java Certifiction", Type.other, Status.pending, 450.00);
		Reimbursement_ Process2 = new Reimbursement_(2, 2, 1, "Travel to Busan HQ", Type.travel, Status.pending, 900.00);
